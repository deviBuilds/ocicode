import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@ocicode/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "ocicode-server-config-test-" });
