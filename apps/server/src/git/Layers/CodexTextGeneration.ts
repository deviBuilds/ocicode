...
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@ocicode/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    const filePath = path.join(tempDir, `ocicode-${prefix}-${process.pid}-${randomUUID()}.tmp`);
