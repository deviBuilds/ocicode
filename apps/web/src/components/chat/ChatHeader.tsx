    ...
    <div className="@container/header-actions flex min-w-0 flex-1 items-center gap-2">
      <div className="flex min-w-0 flex-1 items-center gap-2 overflow-hidden sm:gap-3">
        ...
        {activeProjectName && (
          <Badge
            variant="outline"
            className="min-w-0 shrink overflow-hidden rounded-full border-border/70 bg-background/70 px-2.5"
          >
      ...
      <div className="flex shrink-0 items-center justify-end gap-2 @3xl/header-actions:gap-2.5">
        {activeProjectScripts && (
